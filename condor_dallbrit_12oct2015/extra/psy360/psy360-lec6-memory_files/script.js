...
var gDocTable = new Array(
   ...
   new hrefList("slide0057.htm", 1, 15),
   new hrefList("slide0066.htm", 1, 16),
   new hrefList("slide0063.htm", 1, 17),
   new hrefList("slide0064.htm", 1, 18),
   new hrefList("slide0065.htm", 1, 19),
   new hrefList("slide0058.htm", 1, 20),
   new hrefList("slide0060.htm", 1, 21),
   new hrefList("slide0061.htm", 1, 22),
   new hrefList("slide0059.htm", 1, 23),
   new hrefList("slide0062.htm", 1, 24),
   new hrefList("slide0069.htm", 1, 25),
   new hrefList("slide0070.htm", 1, 26),
   new hrefList("slide0071.htm", 1, 27),
   new hrefList("slide0072.htm", 1, 28),
   new hrefList("slide0073.htm", 1, 29),
   new hrefList("slide0067.htm", 1, 30),
   new hrefList("slide0068.htm", 1, 31),
   new hrefList("slide0074.htm", 1, 32),
   new hrefList("slide0075.htm", 1, 33),
   new hrefList("slide0077.htm", 1, 34),
   new hrefList("slide0076.htm", 1, 35),
   new hrefList("slide0078.htm", 1, 36),
   new hrefList("slide0079.htm", 1, 37),
   new hrefList("slide0080.htm", 1, 38),
   new hrefList("slide0081.htm", 1, 39),
   new hrefList("slide0082.htm", 1, 40),
   new hrefList("slide0083.htm", 1, 41),
   new hrefList("slide0084.htm", 1, 42),
   new hrefList("slide0085.htm", 1, 43),
   new hrefList("slide0086.htm", 1, 44),
   new hrefList("slide0087.htm", 1, 45),
   new hrefList("slide0088.htm", 1, 46),
   new hrefList("slide0089.htm", 1, 47),
   new hrefList("slide0090.htm", 1, 48)
);
