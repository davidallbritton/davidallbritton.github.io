## IMPORTANT: Do not use this code until you try it yourself!
##
## Cut and paste the code from the lab instruction document step by
## step, and try to write your own code where it asks you to.
##
## After trying that, you may then use this file as a "cheat sheet"
## if you are not able to figure it out yourself.  But try it first!
...
# Create arrays for the net(i) in Equation 1
hnet=hidden
onet=output

# Create the stimuli to be learned
...
# Stop here.  Look at the output produced so far.
...
# stop here and look at resulting output before doing test patterns



## test: Get output for all 6 test patterns 
##  (the first 3 learned, the last one learned, and 2 more)
##  Only feedforward, because just testing, not learning.
for(k in 1:6){
    mathc=0
	teach=stimuli[k,]
	input=teach
