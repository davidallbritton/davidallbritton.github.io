ECflag=function(M,L,generations,lb,ub,formula,mutrule,Delta,hardb, minfitflag, maxfitflag, nrepeat){
...
#		readline("Press RETURN to continue")
	...
	lines(fitnesstat[,3],lty=3)
      ...
      if ((fitnesstat[generations,1]< minfitflag) || (fitnesstat[generations,1]>maxfitflag))  {
           readline("Press RETURN to continue")
      }
 }
}

ECflag(10,1,100,-100,100,1,1,1,1, 49, 49.9, 10)
